...
const WORK_STYLE_OPTIONS: {
...
}[] = [
  {
    ...
    label: "자율적으로",
    description:
      "팀이 스스로 판단하고 진행해요. 중요한 것만 가끔 물어봐요. 빠르게 진행하고 싶을 때 좋아요.",
    icon: Zap,
  },
  {
    value: "balanced",
    label: "균형 있게",
    description:
      "중요한 결정은 물어보고, 작은 일은 알아서 해요. 대부분의 경우 이 방식이 좋아요.",
    icon: Scale,
  },
  {
    value: "cautious",
    label: "신중하게",
    description:
      "대부분의 작업 전에 확인을 요청해요. 꼼꼼하게 확인하고 싶을 때 좋아요.",
    icon: Shield,
  },
];
